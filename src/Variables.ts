...
export const Globals: GlobalVariables = {
    ...
    globalCoinMultiplier: 1,
    totalCoinOwned: 0,
    prestigeMultiplier: 1,
    buildingPower: 1,
    reincarnationMultiplier: 1,
    ...
    globalCrystalMultiplier: 1,
    globalMythosMultiplier: 0.01,
    grandmasterMultiplier: 1,

    atomsMultiplier: 1,

    mythosBuildingPower: 1,
    challengeThreeMultiplier: 1,
    totalMythosOwned: 0,

    prestigePointGain: 0,
    challengeFivePower: 1 / 3,

    transcendPointGain: 0,
    reincarnationPointGain: 0,
    ...
    produceFirstDiamonds: 0,
    produceSecondDiamonds: 0,
    produceThirdDiamonds: 0,
    produceFourthDiamonds: 0,
    produceFifthDiamonds: 0,
    produceDiamonds: 0,

    produceFirstMythos: 0,
    produceSecondMythos: 0,
    produceThirdMythos: 0,
    produceFourthMythos: 0,
    produceFifthMythos: 0,
    produceMythos: 0,

    produceFirstParticles: 0,
    produceSecondParticles: 0,
    produceThirdParticles: 0,
    produceFourthParticles: 0,
    produceFifthParticles: 0,
    produceParticles: 0,

    producePerSecond: 0,
    producePerSecondDiamonds: 0,
    producePerSecondMythos: 0,
    producePerSecondParticles: 0,
